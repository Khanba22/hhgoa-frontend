    ...
    <section className="text-white body-font border-t border-gray-700 bg-gray-900">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
          ...
          <p className="lg:w-1/2 w-full leading-relaxed text-base text-gray-300">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table.</p>
        </div>
          ...
          {featuresData.map((feature, index) => (
            <div key={index} className="xl:w-1/3 md:w-1/2 p-4">
              <div className="border border-gray-700 p-6 rounded-lg bg-gray-800">
                ...
                <h2 className="text-lg text-white font-medium title-font mb-2">{feature.title}</h2>
